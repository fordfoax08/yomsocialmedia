...
<body onload="<?php echo isset($_SESSION['err']) ? 'msgPop()': '';?>">
  ...
  <section class="container2">
    <div class="main-container">
      ...
      <div class="post-container <?php echo isset($_GET['user'])? 'close' : '' ;?>">
      ...
      <?php
        ...
        $comments = $connComment->get_user_comments(isset($_GET['user']) ? $_GET['user'] : $_SESSION['a_id']);
        if(count($comments) > 0){
          foreach($comments as $item){
      ?>
        <div class="posted">
          <a class="post-menu <?php echo isset($_GET['user'])? 'close' : '' ;?>" href="javascript:void(0)">
